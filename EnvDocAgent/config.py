...
class Config:
    ...
    # API pricing (USD per 1K tokens) — adjust for your model/provider
    PRICE_PER_1K_INPUT_TOKENS: float = float(os.getenv("PRICE_PER_1K_INPUT_TOKENS", "0.01"))
    PRICE_PER_1K_OUTPUT_TOKENS: float = float(os.getenv("PRICE_PER_1K_OUTPUT_TOKENS", "0.03"))
